...
const MyGeneration = () => {
    ...
    const handleDownload = async (image_url?: string, title = "thumbnail") => {
        if (!image_url){
            return;
        }
                                ...
                                >
                                    ...
                                    <div className={`relative overflow-hidden rounded-t-2xl ${aspectClass} bg-black`}>
                                        ...
                                        {thumbnail.isGenerating && (
                                            <div className="absolute inset-0 bg-black/50 items-center justify-center text-sm font-medium text-white">Generating...</div>
                                        )}
                                    </div>
